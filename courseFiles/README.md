...
Instead of our talk we will have a [peer review session](courseeer-review.md). You will read, comment and fire issues on each others code. Doing this is really good for your programming insight and helps others refining/refactoring their code.
...
#### Friday 23 April
We will have our final [peer review session](courseeer-review.md). You will read, comment and fire issues on each others code. Doing this helps others dotting the i’s on their project.
